...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.letras = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M', 'N', 'Ñ', 'O',
            'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'X', 'Y', 'Z'];
        this.palabra = 'AGUACATE';
        this.palabraOculta = ' ';
        this.intentos = 0;
        this.gano = false;
        this.perdio = false;
    ...
    AppComponent.prototype.comprobar = function (letra) {
    ...
    AppComponent.prototype.verificaGane = function () {
    ...
    AppComponent.prototype.existeLetra = function (letra) {
...
module.exports = __webpack_require__(/*! /home/sergio/Documents/Udemy/ahorcado/src/main.ts */"./src/main.ts");
